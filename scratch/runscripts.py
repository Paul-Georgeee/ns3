...
outDirTemplate = "/home/ybxiao/cc/ns-3-dev/results_without_sometrace/{link}/{tcpType}/{buffersize}-bufferSize/{lossRate}-lossRate/"
...
run("TcpBbr", 0.25, 0.0, 0, 0.5, "12Gbps", "40ms")
run("TcpBbr", 0.25, 0.001, 0, 0.5, "12Gbps", "40ms")

run("TcpBbr", 0.25, 0.0, 1, 0.5, "12Gbps", "40ms")
run("TcpBbr", 0.25, 0.001, 1, 0.5, "12Gbps", "40ms")
