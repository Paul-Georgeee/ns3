...
# run("TcpCubic", 0.25, 0.0, 0, 0.5, "100Mbps", "40ms")
# run("TcpCubic", 0.25, 0.01, 0, 0.5, "100Mbps", "40ms")
    
run("TcpBbr", 0.25, 0.0, 0, 0.5, "100Mbps", "40ms")
run("TcpBbr", 0.25, 0.01, 0, 0.5, "100Mbps", "40ms")

run("TcpBbr", 0.25, 0.0, 1, 0.5, "100Mbps", "40ms")
run("TcpBbr", 0.25, 0.01, 1, 0.5, "100Mbps", "40ms")
